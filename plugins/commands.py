    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝐌𝐑𝐂𝐔𝐏𝐃𝐀𝐓𝐄 ⚔️', url="https://t.me/MRCUPDATE") ] ] ),
            )
        return
        ...
        for msg in msgs:
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    caption=f_caption,
                    protect_content=msg.get('protect', False),
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝖯𝐌𝐑𝐂𝐔𝐏𝐃𝐀𝐓𝐄 ⚔️', url="https://t.me/MRCUPDATE") ] ] ),
                )
            except Exception as e:
